...
?>
			...
			<ul class="breadcrumb">
				<li>
					<i class="icon-home"></i>
					<a href="<?php echo base_url() ?>index.php/depthead/index">Home</a> 
					<i class="icon-angle-right"></i>
				</li>
				<li><a href="<?php echo base_url() ?>index.php/depthead/index">Dashboard</a></li>
			</ul>
...
var graph_data_problem=[];
   ...
   $.ajax({
		           ...
		           url:"http://localhost/complain/index.php/depthead/process_graph_problem",
		           method:"post",
		           dataType: "json",
...
var graph_data_thana=[];
   ...
   $.ajax({
		           ...
		           url:"http://localhost/complain/index.php/depthead/process_graph_thana",
		           method:"post",	  
		           dataType: "json",
...
var graph_data_district=[];
   ...
   $.ajax({
		           ...
		           url:"http://localhost/complain/index.php/depthead/process_graph_district",
		           method:"post",	  
		           dataType: "json",
...
var graph_data_division=[];
   ...
   $.ajax({
		           ...
		           url:"http://localhost/complain/index.php/depthead/process_graph_division",
		           method:"post",
		           dataType: "json",
...
var graph_data_memarea=[];
   ...
   $.ajax({
		           ...
		           url:"http://localhost/complain/index.php/depthead/process_graph_memarea",
		           method:"post",
		           dataType: "json",
...
var graph_data_progress=[];
   ...
   $.ajax({
		           ...
		           url:"http://localhost/complain/index.php/depthead/process_graph_progress",
		           method:"post",
		           dataType: "json",
