...
?>
			...
			<ul class="breadcrumb">
				...
				<li><a href="<?php echo base_url() ?>index.php/user/index">Dashboard</a></li>
			</ul>
...
<div id="container_problem" style="min-width: auto; height: 400px; max-width: auto; margin: 0 auto" /> </div> <!-- overflow-x: auto; -->
<div id="container_thana" style="min-width: auto; height: 400px; max-width: auto; margin: 0 auto" /> </div> <!-- overflow-x: auto; -->
<div id="container_district" style="min-width: auto; height: 400px; max-width: auto; margin: 0 auto" /> </div> <!-- overflow-x: auto; -->
<div id="container_division" style="min-width: auto; height: 400px; max-width: auto; margin: 0 auto" /> </div> <!-- overflow-x: auto; -->
<div id="container_memarea" style="min-width: auto; height: 400px; max-width: auto; margin: 0 auto" /> </div> <!-- overflow-x: auto; -->
<div id="container_progress" style="min-width: auto; height: 400px; max-width: auto; margin: 0 auto" /> </div> <!-- overflow-x: auto; -->
...
var graph_data_problem=[];
   ...
   $.ajax({
		           ...
		           url:"http://localhost/complain/index.php/user/process_graph_problem",
		           method:"post",
		           dataType: "json",
...
var graph_data_thana=[];
   ...
   $.ajax({
		           ...
		           url:"http://localhost/complain/index.php/user/process_graph_thana",
		           method:"post",	  
		           dataType: "json",
...
var graph_data_district=[];
   ...
   $.ajax({
		           ...
		           url:"http://localhost/complain/index.php/user/process_graph_district",
		           method:"post",	  
		           dataType: "json",
...
var graph_data_division=[];
   ...
   $.ajax({
		           ...
		           url:"http://localhost/complain/index.php/user/process_graph_division",
		           method:"post",
		           dataType: "json",
...
var graph_data_memarea=[];
   ...
   $.ajax({
		           ...
		           url:"http://localhost/complain/index.php/user/process_graph_memarea",
		           method:"post",
		           dataType: "json",
...
var graph_data_progress=[];
   ...
   $.ajax({
		           ...
		           url:"http://localhost/complain/index.php/user/process_graph_progress",
		           method:"post",
		           dataType: "json",
